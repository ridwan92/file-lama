	...
	?>
      ...
      <form id="commentForm" name="commentForm"  method="post" action="<?=site_url('backend/categories/insert/'.$mode.'/'.$id);?>">
			...
			<fieldset>				
				<table class="nostyle">
					...
					<tr>
						...
						<td><input type="file" name="File" class="input-text" required="required" ></td>
					</tr>
					<tr>
